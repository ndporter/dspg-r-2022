...
![Diagram illustrating use of select function to select two columns of a data frame](../fig/10-dplyr-fig1.png)
...
![Diagram illustrating how the group by function oraganizes a data frame into groups](../fig/10-dplyr-fig2.png)
