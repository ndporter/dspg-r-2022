...
![Diagram illustrating the difference between a wide versus long layout of a data frame](../fig/11-tidyr-fig1.png)
...
![Diagram illustrating the wide format of the gapminder data frame](../fig/11-tidyr-fig2.png)
...
![Diagram illustrating how pivot longer reorganizes a data frame from a wide to long format](../fig/11-tidyr-fig3.png)
...
![Diagram illustrating the long format of the gapminder data](../fig/11-tidyr-fig4.png)
