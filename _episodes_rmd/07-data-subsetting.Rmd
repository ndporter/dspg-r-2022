...
Let's start with the workhorses of R, simple numeric and character vectors.
...
So now that we've created dummy vectors to play with, how do we get at their
contents?
...
![Inequality testing](../fig/07-rmd-inequality.1.png)

When one vector is shorter than the other, it gets *recycled*:

![Inequality testing: results of recycling](../fig/07-rmd-inequality.2.png)
