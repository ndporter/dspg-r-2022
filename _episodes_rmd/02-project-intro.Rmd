...
![Screenshot of file manager demonstrating bad project organisation](../fig/02-bad_layout.png)
...
![Screenshot of RStudio project on dev branch with new folders](../fig/02-rstudio-project-folders.png)
